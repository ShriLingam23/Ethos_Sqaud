                            ...
                            <div className="row" style={{marginBottom:'-25px'}}>
                                <div className="col-md-4">
                                    <div className="card mb-4 shadow-sm">
                                        ...
                                        <p className="card-text">Any opinions in the examples do not represent the opinion of the Cambridge Dictionary editors or of Cambridge University Press or its licensors.A specialised subject that involves skill. </p>
                                ...
                                <div className="col-md-4">
                                    <div className="card mb-4 shadow-sm">
                                        ...
                                        <hr className="md-2"/>
                                        <img src={course} className="card-img-top" alt="..." style={{paddingLeft:'7px',paddingRight:'7px'}}/>
                                        <div className="card-body">
                                            <p className="card-text">Courses are designed for continuing personal development and are offered by a number of leading universities, schools, and other educational institutions around the world.</p>
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
                                ...
                                <div className="col-md-4">
                                    <div className="card mb-4 shadow-sm">
                                        ...
                                        <hr className="md-2"/>
                                        <img src={student} className="card-img-top" alt="..." style={{paddingLeft:'7px',paddingRight:'7px'}}/>
                                        <div className="card-body">
                                            <p className="card-text">A student is primarily a person enrolled in a school or other educational institution who attends classes in a course to attain the appropriate level of mastery of a subject</p>
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="btn-group">
